...
class SuperTrendWidgetSearch extends StatelessWidget {
  final SuperTrendController controller;

  const SuperTrendWidgetSearch({Key? key, required this.controller}) : super(key: key);
    ...
    return TypeAheadField<Crypto>(
      ...
      itemBuilder: (context, Crypto crypto) {
        return Container(
          ...
          color: TColors.black,
          child: ListTile(
            title: Text(crypto.symbol,style: TextStyle(color: TColors.complementary),),
          ),
        );
      },
